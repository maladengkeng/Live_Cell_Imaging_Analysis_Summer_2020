...
noiseReducedImage = normalizedImage*cytoplasmicFlourescenceSTD;

filter_width = 1.5;
[~,~,fluorFiltered] = curveFilter(noiseReducedImage,filter_width);
    ...
    if ~isempty( bestCellID )
        if tempData.intensity > 1
            ...
            if fitScore > 0.5
                ...
                tempData.power = tempData.intensity*2*pi*tempData.fitSigma^2;
